...
const STORE = {
  user_a5c7651399a6423caf8f794a6f033311: {
    user: {
      id: 'user_a5c7651399a6423caf8f794a6f033311', email: 'ok@example.com', password: 'password',
    },
    account: {
      apikeys: [
        ...
        {
          label: 'Billing (Test)',
          id: 'test_8cf7c437ccf545bf810b099b15bbe0cd',
...
app.delete('/apikeys/:apikeyId', (req, res) => {
  ...
  if (!apikey) { res.sendStatus(404); return; }
  res.sendStatus(204); // all ok, no response content required
});
